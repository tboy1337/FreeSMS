...
def generate_sms_icon(
    ...
    try:
        ...
        draw.line(
            [(s_x_left, s_y_top), (s_x_right, s_y_top)],
            fill=background_color,
            width=line_width,
        )
        # Middle vertical line of S
        draw.line(
            [(s_x_left, s_y_top), (s_x_left, s_y_middle)],
            fill=background_color,
            width=line_width,
        )
        # Middle horizontal line of S
        draw.line(
            [(s_x_left, s_y_middle), (s_x_right, s_y_middle)],
            fill=background_color,
            width=line_width,
        )
        # Bottom vertical line of S
        draw.line(
            [(s_x_right, s_y_middle), (s_x_right, s_y_bottom)],
            fill=background_color,
            width=line_width,
        )
        # Bottom horizontal line of S
        draw.line(
            [(s_x_left, s_y_bottom), (s_x_right, s_y_bottom)],
            fill=background_color,
            width=line_width,
        )
