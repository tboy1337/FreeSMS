#!/usr/bin/env python3
"""
Test script for FreeSMS models
"""
...
class TestDatabase(unittest.TestCase):
    ...
    def test_api_credentials(self):
        ...
        result = self.db.save_api_credentials(
            "twilio",
            {
...
class TestContactManager(unittest.TestCase):
    ...
    def test_get_contacts(self):
        ...
        self.db.get_contact.return_value = {
            "id": 1,
            "name": "John Doe",
            "phone": "+12125551234",
        }
    ...
    def test_update_contact(self):
        ...
        with patch(
            ...
            result = self.manager.update_contact(
                1, "New Name", "12125559876", "US", "New note"
            )
            self.assertTrue(result)
            self.db.save_contact.assert_called_once_with(
                "New Name", "+12125559876", "US", "New note"
            )
    ...
    def test_search_contacts(self):
        ...
        self.db.search_contacts = MagicMock(
            return_value=[
                {
                    "id": 1,
                    "name": "John Doe",
        ...
        with patch.object(
            self.manager, "search_contacts", side_effect=mock_search_contacts
        ):
            # Test searching contacts
    ...
    def test_export_contacts_to_csv(self):
        ...
        self.manager.get_all_contacts = MagicMock(
            return_value=[
                {
                    "id": 1,
                    "name": "Test User",
        ...
        with patch("phonenumbers.parse") as mock_parse:
            with patch("phonenumbers.is_valid_number", return_value=True):
                with patch("phonenumbers.format_number", return_value="+12125551234"):
                    valid, formatted = self.manager._validate_phone_number(
                        "2125551234", "US"
                    )
