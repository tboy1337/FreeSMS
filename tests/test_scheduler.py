...
class TestMessageScheduler(unittest.TestCase):
    ...
    def setUp(self):
        ...
        with patch("schedule.every") as mock_schedule:
            self.scheduler = MessageScheduler(
                database=self.mock_db, service_manager=self.mock_service_manager
            )
    ...
    def test_init(self):
        ...
        mock_schedule.return_value.minutes.do.assert_called_once_with(
            scheduler.check_due_messages
        )
    ...
    def test_process_scheduled_message_success(self):
        ...
        mock_callback.assert_called_once_with(
            "message_sent",
            {"message_id": 1, "recipient": "+1234567890", "status": "sent"},
        )
    ...
    def test_process_scheduled_message_invalid_object(self):
        ...
        for invalid_message in invalid_messages:
            with patch("src.automation.scheduler.logger") as mock_logger:
    ...
    def test_schedule_message_failure(self):
        ...
        result = self.scheduler.schedule_message(
            recipient="+1234567890", message="Test message", schedule_time=schedule_time
        )
    ...
    def test_cancel_scheduled_message_success(self):
        ...
        mock_callback.assert_called_once_with("message_cancelled", {"message_id": 123})
    ...
    def test_update_scheduled_message_success(self):
        ...
        mock_callback.assert_called_once_with("message_updated", {"message_id": 123})
    ...
    def test_update_scheduled_message_not_found(self):
        ...
        result = self.scheduler.update_scheduled_message(
            message_id=999, message="New message"
        )
    ...
    def test_update_scheduled_message_string_recurrence_data(self):
        ...
        result = self.scheduler.update_scheduled_message(
            message_id=123, recurrence_data='{"days_interval": 3}'
        )
    ...
    def test_get_scheduled_messages_with_json_interval(self):
        ...
        mock_messages = [
            {"id": 1, "message": "Test 1", "recurring_interval": '{"days_interval": 5}'}
        ]
        self.mock_db.get_scheduled_messages.return_value = mock_messages
    ...
    def test_get_scheduled_messages_with_invalid_json(self):
        ...
        mock_messages = [
            {"id": 1, "message": "Test 1", "recurring_interval": "invalid-json"}
        ]
        self.mock_db.get_scheduled_messages.return_value = mock_messages
    ...
    def test_register_callback(self):
        ...
        self.scheduler.register_callback(
            "message_sent", callback2
        )  # Multiple for same event
